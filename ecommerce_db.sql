...
--
-- Host: localhost
-- Generation Time: May 28, 2026 at 07:45 AM
...
(1, 'Mohammed Zomlot', 'mohammedzomlot2@gmail.com', '$2y$10$orhuTUVyrgMs7rJfDD4YuukHfLXrYzYBSKp6dMq/Jjqq.CofsAPye', '+970593628153', '', 'customer', '2026-05-27 11:37:09');
...
--
ALTER TABLE `newsletter_subscribers`
  MODIFY `newsletter_subscriber_id` int(11) NOT NULL AUTO_INCREMENT;
...
('root', '[{\"db\":\"ecommerce_db\",\"table\":\"login_attempts\"},{\"db\":\"ecommerce_db\",\"table\":\"products\"},{\"db\":\"ecommerce_db\",\"table\":\"categories\"},{\"db\":\"ecommerce_db\",\"table\":\"newsletter_subscribers\"},{\"db\":\"ecommerce_db\",\"table\":\"orders\"},{\"db\":\"ecommerce_db\",\"table\":\"contacts\"},{\"db\":\"ecommerce_db\",\"table\":\"cart_items\"},{\"db\":\"ecommerce_db\",\"table\":\"order_items\"},{\"db\":\"ecommerce_db\",\"table\":\"users\"}]');
...
('ecommerce_db', 'products', 'category_id');
...
('root', '2026-05-28 05:43:35', '{\"Console\\/Mode\":\"collapse\"}');
