  ...
  <main class="admin-content">
    <div class="admin-header">
      ...
      <div class="d-flex align-items-center gap-2">
        <div class="profile-avatar" style="width:36px;height:36px;font-size:var(--font-size-sm);"><?= $_SESSION['full_name'][0] ?></div>
              ...
              <tbody>
                ...
                <?php foreach ($orders as $order): ?>
                  ...
                  <tr>
                    ...
                    <td><?= number_format((float) $order->total_amount, 2) ?> ش</td>
                    <td><span class="status-badge <?= $status['class'] ?>"><i class="bi <?= $status['icon'] ?>"></i> <?= htmlspecialchars($status['label'], ENT_QUOTES, 'UTF-8') ?></span></td>
            ...
            <?php foreach ($topProducts as $product): ?>
              <div class="d-flex align-items-center gap-3">
                ...
                <div style="flex:1;min-width:0;">
                  <h6 style="font-size:var(--font-size-sm);font-weight:600;margin-bottom:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?= $product->name ?></h6>
                  <span style="font-size:var(--font-size-xs);color:var(--color-text-muted);"><?= $product->total_sold ?> مباع</span>
                </div>
                <span style="font-size:var(--font-size-sm);font-weight:600;color:var(--color-primary);"><?= $product->price ?> ش</span>
              </div>
            <?php endforeach; ?>
          </div>
        </div>
